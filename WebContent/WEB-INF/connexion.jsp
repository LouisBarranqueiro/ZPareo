...
<html>
	<head>
        ...
        <link type="text/css" rel="stylesheet" href="<c:url value="/ressources/scss/style.css"/>"/>
	</head>
	<body>
		...
		<script type="text/javascript" src="<c:url value="/ressources/js/highcharts.js"/>"></script>
		<script type="text/javascript" src="<c:url value="/ressources/js/jquery-ui.custom.min.js"/>"></script>
		<script type="text/javascript" src="<c:url value="/ressources/js/jquery.tablesorter.min.js"/>"></script>
		<script type="text/javascript" src="<c:url value="/ressources/js/jquery.ui.datepicker-fr.js"/>"></script>

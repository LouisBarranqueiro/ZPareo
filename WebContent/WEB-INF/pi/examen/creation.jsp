...
<form id="create-test" action="<c:url value="pi/examen/creation"/>" method="POST" class="form--horizontal">
    ...
    <div class="modal__mod--lg">
        <input type="hidden" name="teacher" class="form--control" value="<c:out value='${ sessionScope.sessionProfesseur.id }'/>" pattern=".{5,55}" readonly="readonly" required="required"/>
        <label>FORMAT</label>

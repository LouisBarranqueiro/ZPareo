        ...
        <div id="site-wrap">
            ...
            <div id="main-wrap" class="main">
                <div class="main__head">
                    ...
                    <p class="main__head__desc"><c:out value="${ nbAdministrateurs }"/> administrateurs enregistrés</p>
                                ...
                                <tbody>
                                    <c:forEach items="${ listeAdministrateurs }" var="administrateur">
                                        <tr class="tr--md">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn--icon" onclick="displayRespModal('ai/administrateur/edition?id=<c:out value="${ administrateur.id }"/>',300)"><span class="icon-edit"></span></button>
                                                    <button type="button" class="btn btn--icon" onclick="displayRespModal('ai/administrateur/suppression?id=<c:out value="${ administrateur.id }"/>','auto')"><span class="icon-trashcan"></span></button>
                                                </div>
                                            </td>
                                        </tr>
                                     </c:forEach>

...
<form id="edition-administrateur" action="http://localhost:8080/ZPareo/ai/administrateur/edition" method="POST" class="form--horizontal">
    ...
    <div class="modal__mod--lg">
	    ...
	    <input type="password" name="motDePasse" class="form--control" pattern=".{8,}" placeholder="Nouveau mot de passe" x-moz-error-message="Veuillez entrez un mot de passe composer de 8 caractères minimum"/>

...
<form id="create-group" action="<c:url value="ai/groupe/creation"/>" method="POST" class="form--horizontal">
    ...
    <div class="modal__mod--lg">
	    <label>NOM</label>
	    <input type="text" name="name" class="form--control" value="<c:out value='${ groupe.nom }'/>" size="30" pattern="(G|g)[A-Za-z]" x-moz-errormessage="Veuillez entrer un nom de 2 caractères commencant par G" required/>

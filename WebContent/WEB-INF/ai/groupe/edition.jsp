...
<form id="edit-group" action="<c:url value="ai/groupe/edition"/>" method="POST" class="form--horizontal">
    ...
    <div class="modal__mod--lg">
    	...
    	<input type="text" name="name" class="form--control" size="30" value="${ groupe.nom }" pattern="(G|g)[A-Za-z]" placeholder="Nom" x-moz-errormessage="Veuillez entrer un nom de 2 caractères commencant par G" required/>
    	<span class="form__error">${ form.erreurs['name'] }</span>

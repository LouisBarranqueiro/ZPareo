                                ...
                                <tbody>
                                    <c:forEach items="${ listeMatieres }" var="matiere" >
                                        <tr class="tr--md">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn--icon" onclick="displayRespModal('ai/matiere/edition?id=<c:out value="${ matiere.id }"/>',300)"><span class="icon-edit"></span></button>
                                                    <button type="button" class="btn btn--icon" onclick="displayRespModal('ai/matiere/suppression?id=<c:out value="${ matiere.id }"/>','auto')"><span class="icon-trashcan"></span></button>
                                                </div>
                                            </td>
                                        </tr>
                                     </c:forEach>

...
<form id="create-matter" action="<c:url value="ai/matiere/creation"/>" method="POST" class="form--horizontal">
    ...
    <div class="modal__mod--lg">
	    <input type="text" name="name" class="form--control" value="<c:out value='${matiere.nom}'/>" size="30" pattern="[a-zA-Z0-9.-\' ]{2,50}" placeholder="Nom" x-moz-errormessage="Veuillez entrez un nom correct" required/>

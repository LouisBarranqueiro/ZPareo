        ...
        <div id="site-wrap">
            ...
            <div id="main-wrap" class="main">
                <div class="main__head">
                    <h1 class="main__head__title">Liste des étudiants</h1>
                    <p class="main__head__desc"><c:out value="${ nbEtudiants }"/> étudiants enregistrés</p>
                    <button type="button" class="btn btn--success main__head__control" onclick="affFormCreation('ai/etudiant',300)">AJOUTER UN ETUDIANT</button>
                </div>
                                ...
                                <tbody>
                                    <c:forEach items="${ listeEtudiants }" var="etudiant" >
                                        <tr class="tr--md">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn--icon" onclick="affFormEdition('ai/etudiant',<c:out value="${ etudiant.id }"/>,300)"><span class="icon-edit"></span></button>
                                                    <button type="button" class="btn btn--icon" onclick="affFormSuppr('ai/etudiant',<c:out value="${ etudiant.id }"/>,'auto')"><span class="icon-trashcan"></span></button>
                                                    <button type="button" class="btn btn--icon" onclick="affForm('ai/etudiant/reinit-mot-de-passe',<c:out value="${ etudiant.id }"/>,'auto')"><span class="icon-rotate"></span></button>
                                                </div>
                                            </td>
                                        </tr>
                                     </c:forEach>

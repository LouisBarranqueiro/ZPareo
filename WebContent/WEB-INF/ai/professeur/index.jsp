        ...
        <div id="site-wrap">
            ...
            <div id="main-wrap" class="main">
                <div class="main__head">
                    ...
                    <button type="button" class="btn btn--success main__head__control" onclick="affFormCreation('ai/professeur',600)">AJOUTER UN PROFESSEUR</button>
                </div>
                                ...
                                <tbody>
                                    <c:forEach items="${ listeProfesseurs }" var="professeur" >
                                        <tr class="tr--md">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn--icon" onclick="affFormDetails('ai/professeur',<c:out value="${ professeur.id }"/>,'auto')"><span class="icon-list2" ></span></button>
                                                    <button type="button" class="btn btn--icon" onclick="affFormEdition('ai/professeur',<c:out value="${ professeur.id }"/>,600)"><span class="icon-edit"></span></button>
                                                    <button type="button" class="btn btn--icon" onclick="affFormSuppr('ai/professeur',<c:out value="${ professeur.id }"/>,'auto')"><span class="icon-trashcan"></span></button>
                                                </div>
                                            </td>
                                        </tr>
                                     </c:forEach>

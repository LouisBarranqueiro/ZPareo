...
<form id="creation-professeur" action="http://localhost:8080/ZPareo/professeur/creation" method="POST" class="form--horizontal">
    ...
    <div class="modal__mod--sm modal__mod--vertical">
        <label>PRENOM</label>
        <input type="text" name="prenom" class="form--control" size="39" value="<c:out value='${ professeur.prenom }'/>" pattern="[a-zA-Z ]{2,50}" x-moz-error-message="Veuillez entrez un prenom correct composer de 2 à 50 caractères" required/>
        <span class="form__error">${ form.erreurs['prenom'] }</span>
        <label>NOM</label>
        <input type="text" name="nom" class="form--control" size="39" value="<c:out value='${ professeur.nom }'/>" pattern="[a-zA-Z ]{2,50}" x-moz-error-message="Veuillez entrez un nom correct composer de 2 à 50 caractères" required/>
        ...
        <input type="password" name="motDePasse" class="form--control" size="39" pattern=".{8,}" x-moz-error-message="Veuillez entrez un mot de passe composer de 8 caractères avec au moins une minucule, une majuscule, un chiffre et un caractère spéciale" required/>

                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button" class="bouton bouton-action" onclick="affFormSuppr('ai/administrateur',<c:out value="${ administrateur.id }"/>,'auto')"><span class="icon-trashcan"></span></button>
                                                    </div>
                                                </td>
                                            </tr>
                                         </c:forEach>

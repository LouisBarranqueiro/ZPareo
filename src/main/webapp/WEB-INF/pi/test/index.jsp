        ...
        <div id="site-wrap">
            ...
            <div id="main-wrap" class="main">
                <div class="main__head">
                    ...
                    <p class="main__head__desc"><c:out value="${numbTests}"/> examens enregistr�s</p>
                        ...
                        <form action="<c:url value="/pi/examen"/>" method="GET" class="form--inline">
                            <table class="table">
                                <thead>
                                    ...
                                    <tr class="tr--search">
                                        <th><input type="text" name="id" size="8" pattern="[0-9]+" placeholder="Reference" x-moz-errormessage="Veuillez entrez une r�f�rence correcte"/></th>

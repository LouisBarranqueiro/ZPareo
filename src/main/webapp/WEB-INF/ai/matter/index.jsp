...
<html>
    <head>
        ...
        <title>ZPareo - Liste des mati�res</title>
        ...
        <div id="site-wrap">
            ...
            <div id="main-wrap" class="main">
                <div class="main__head">
                    <h1 class="main__head__title">Liste des mati�res</h1>
                    <p class="main__head__desc"><c:out value="${numbMatters}"/> mati�re(s) enregistr�e(s)</p>
                ...
                <div class="main__content">
                    <div class="mod mod--lg">
                        <form action="<c:url value="/ai/matiere"/>" method="GET" class="form--inline">
                            <table class="table">
                                <thead>
                                    <tr class="tr--ref">

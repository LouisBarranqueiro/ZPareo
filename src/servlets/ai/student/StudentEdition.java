...
public class StudentEdition extends HttpServlet 
{
	...
	private static final String VIEW             = "/WEB-INF/ai/student/edition.jsp";
	private StudentDao etudiantDao;
	private GroupDao groupeDao;
	
	public void init() throws ServletException 
    {
		this.etudiantDao = ((DAOFactory) getServletContext().getAttribute(CONF_DAO_FACTORY)).getStudentDao();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		StudentForm studentForm = new StudentForm(this.etudiantDao);
